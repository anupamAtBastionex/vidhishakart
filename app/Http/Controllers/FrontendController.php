...
class FrontendController extends Controller
{
    ...
    public function unclaimableProducts(){
        return view('frontend.pages.unclaimable-product');
    }
    ...
    public function productDetail($slug)
    {
        ...
        //$cahecData              = json_decode(Cache::get('current_user'));  
         $cahecData             = json_decode(Cache::get('current_user_'.$sessionId));
     //   $sessionId = session()->getId();
        if(empty($cahecData))
        {
            $cahecData = new \stdClass();
        }
    ...
    public function subscribe(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
                                                'email'=>'string|required|unique:subscribers,email',
                                        ]);
